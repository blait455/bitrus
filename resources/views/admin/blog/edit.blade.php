            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.blog.update', $blog) }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-2 col-form-label text-md-right">Body</label>

                            <div class="col-md-6">
                                <textarea name="body" id="body" class="form-control @error('body') is-invalid @enderror" cols="30" rows="5">{{ $blog->body }}</textarea>
